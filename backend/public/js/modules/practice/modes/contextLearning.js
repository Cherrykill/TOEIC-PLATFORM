// ===================================
// CONTEXT LEARNING MODE - Hoc tu vung qua cau vi du
// Hien cau vi du (example), chon nghia tieng Viet (vn)
// ===================================
...
const ContextLearning = {
    ...
    /**
     * Generate questions - only words that have example sentences
     */
    async generateQuestions() {
        ...
        // Generate multiple choice questions with Vietnamese options
        this.questions = selectedWords.map(word => {
            return this.generateContextQuestion(word, wordsWithExamples);
        });

        console.log(`📝 Generated ${this.questions.length} context learning questions`);
    },

    /**
     * Generate a context question for a word
     */
    generateContextQuestion(word, allWords) {
        // Get 3 wrong Vietnamese options from other words
    ...
    render(question) {
        ...
        // Auto pronounce example sentence (audio only, no text shown)
        setTimeout(() => {
    ...
    selectAnswer(index) {
        ...
        // Reveal everything after answering
    ...
    /**
     * Show word info after answering
     */
    showWordInfo(word) {
     ...
     */
    cleanup() {
        console.log('🧹 ContextLearning cleanup: Clearing state');
...
// Make global
window.ContextLearning = ContextLearning;

// Export
if (typeof module !== 'undefined' && module.exports) {
    module.exports = ContextLearning;
}
